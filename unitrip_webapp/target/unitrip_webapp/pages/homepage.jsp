                    ...
                    <div class="card-body p-4">
                        <div class="text-center">
                            ...
                            <form method="post" action="<%=request.getContextPath()%>/HomepageServlet">
                                <input id="Trip" type="hidden" name="trip_name" value="<%=trip.getTripName()%>">
                                <input id="User" type="hidden" name="username" value="<%=request.getSession().getAttribute("username")%>">
                                <input style="font-size:12pt" name="favButton" class="btn btn-outline-dark mt-auto" type="submit" value="ADD TO FAVORITES">
                            </form>
                            <h3><%=trip.getDate()%></h3>
